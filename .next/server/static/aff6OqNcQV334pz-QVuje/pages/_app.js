...
// EXTERNAL MODULE: external "react-fullstory"
var external_react_fullstory_ = __webpack_require__("nI0f");

// EXTERNAL MODULE: ./src/config/theme.js
var theme = __webpack_require__("oCNv");

// CONCATENATED MODULE: ./src/config/seo.js
/* harmony default export */ var seo = ({
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return _app_FSATApp; });
...
class _app_FSATApp extends app_default.a {
  componentDidMount() {
  ...
  render() {
    ...
    return (// Make sure MUI styles are loaded first, so that any subsequent overrides using SC styles will be preserved.
      ...
      }, __jsx(external_notistack_["SnackbarProvider"], {
        maxSnack: 3
      }, __jsx(CssBaseline_default.a, null),  false && false, __jsx(external_next_seo_["DefaultSeo"], seo), __jsx(Component, modifiedPageProps))))
    );
  }
