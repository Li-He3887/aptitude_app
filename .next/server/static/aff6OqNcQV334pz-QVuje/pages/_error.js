...
/* harmony import */ var _sentry_node__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("UAhG");
...
const FSATError = ({
  ...
  if (!hasGetInitialPropsRun && err) {
    ...
    _sentry_node__WEBPACK_IMPORTED_MODULE_2__["captureException"](err);
  }
...
FSATError.getInitialProps = async ({
  ...
  _sentry_node__WEBPACK_IMPORTED_MODULE_2__["captureException"](new next_error__WEBPACK_IMPORTED_MODULE_1___default.a(`_error.js getInitialProps missing data at path: ${asPath}`));
  return errorInitialProps;
};

/* harmony default export */ __webpack_exports__["default"] = (FSATError);
