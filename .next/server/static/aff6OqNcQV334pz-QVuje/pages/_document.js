...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FSATDocument; });
...
/* harmony import */ var styled_jsx_server__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__("2+G7");
...
/* harmony import */ var _config_theme__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__("oCNv");
...
class FSATDocument extends next_document__WEBPACK_IMPORTED_MODULE_8___default.a {
  static async getInitialProps(ctx) {
    ...
    const muiStyleSheets = new _material_ui_core_styles__WEBPACK_IMPORTED_MODULE_9__["ServerStyleSheets"]();
    const scStyleSheet = new styled_components__WEBPACK_IMPORTED_MODULE_10__["ServerStyleSheet"]();
    ...
    try {
      ...
      return _objectSpread({}, initialProps, {
        styles: __jsx(react__WEBPACK_IMPORTED_MODULE_7___default.a.Fragment, null, initialProps.styles, muiStyleSheets.getStyleElement(), scStyleSheet.getStyleElement(), styled_jsx_server__WEBPACK_IMPORTED_MODULE_11___default()() || null)
      });
    } finally {
      scStyleSheet.seal();
    }
  ...
  render() {
    return __jsx("html", {
      ...
      name: "theme-color",
      content: _config_theme__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"].palette.primary.main
    }), __jsx("link", {
      rel: "shortcut icon",
      type: "image/x-icon",
      href: "/favicon.ico"
